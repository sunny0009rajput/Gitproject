...
def extract_english_pdf_to_json(pdf_path, output_json="sentenceimprovement11.json"):
    ...
    for i in range(1, len(sections), 2):
        ...
        for q_num, q_text in question_blocks:
            ...
            # ✅ Extract main status (SSC CPO 04 / 10 / 2023 etc.)
            ...
            # ✅ Capture shift or time (1st Shift, Morning, etc.)
            shift_match = re.search(r"\b(1st|2nd|3rd)\s*Shift\b|\b(Morning|Evening|Afternoon)\b", q_text, re.IGNORECASE)
            if shift_match:
