                ...
                <div className="space-y-6">
                  <div>
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white-800 border border-gray-700 rounded-lg text-black placeholder-gray-800 focus:border-red-500 focus:outline-none transition-colors duration-300"
                    />
                    {errors.name && (
                  ...
                  <div>
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-white-800 border border-gray-700 rounded-lg text-black placeholder-gray-800 focus:border-red-500 focus:outline-none transition-colors duration-300 resize-none"
                    ></textarea>
                    {errors.message && (
                      <p className="text-red-500 text-sm mt-1">
                        {errors.message}
