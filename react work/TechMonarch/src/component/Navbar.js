...
function Navbar() {
  ...
  return (
    <div className="bg-white text-black overflow-x-hidden">
      <nav
        ref={navRef}
        className="fixed top-0 w-full bg-white/90 backdrop-blur-md z-50 border-b border-white-800"
      >
            ...
            <div className="hidden md:flex space-x-8">
              {sections.map((section) => (
                <a
                  key={section}
                  href={`#${section}`}
                  className={`text-black-300 hover:text-red-500 transition-colors duration-300 font-medium relative group ${
