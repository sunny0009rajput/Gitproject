...
export default function HeroRenovation() {
  ...
  const projects = [
      ...
      { id: 1, title: 'Vikram Desai', category: 'renovation', image: 're101.png', description: 'Family-friendly housing society with parks and shops.' },
      { id: 2, title: 'Ritika Bansal', category: 'renovation', image: 're102.png', description: 'Premium office towers with easy metro access.' },
      ...
      <div className="relative bg-white overflow-hidden">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Sigam Builder Construction brings new life to old spaces with expert renovation solutions,
combining quality craftsmanship and modern design to transform your property beautifully and efficiently.
          </p>
        </div>
      </div>
