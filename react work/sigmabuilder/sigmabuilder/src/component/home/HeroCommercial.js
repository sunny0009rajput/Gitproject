      ...
      <div className="relative bg-white overflow-hidden">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Sigma Builder Construction offers reliable and efficient commercial
            construction services, tailored to meet the needs of growing
            businesses. From retail spaces to office complexes, we deliver
            functional, well-designed structures with a focus on quality,
            durability, and timely completion
          </p>
        </div>
      </div>
