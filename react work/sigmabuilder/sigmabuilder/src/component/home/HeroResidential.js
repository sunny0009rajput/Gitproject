...
export default function HeroResidential() {
      ...
      <div className="relative bg-white overflow-hidden">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
             Sigma Builder Construction specializes in high-quality residential construction, delivering homes
that combine smart design, structural strength, and modern living comforts.
          </p>
        </div>
      </div>
