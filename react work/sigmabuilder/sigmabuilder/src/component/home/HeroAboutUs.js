...
const HeroAboutUs = () => {
  const socialLinks = [
    {
      ...
      url: "https://www.youtube.com/@SigmaBuilders51",
      hoverColor: "hover:bg-red-600"
    },
    {
      name: "Instagram", 
      icon: <Instagram className="w-6 h-6" />,
      url: "https://www.instagram.com/sigma_buildersofficial/",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 py-16 px-4">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <p className="text-white text-base lg:text-lg leading-relaxed">
                We are a leading real estate and construction company, crafting exceptional residential and commercial properties with modern design, functionality, and lasting quality.
              </p>
              
              <p className="text-white text-base lg:text-lg leading-relaxed">
                With a focus on transparency, innovation, and excellence, our team of architects and designers brings your vision to life, creating spaces that inspire better living and working experiences.
              </p>
            </div>

            {/* Social Links */}
            <div className="pt-4">
              <p className="text-white text-base mb-4">Find Sigma Builder on:</p>
