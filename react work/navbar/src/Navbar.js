  ...
  return (
    <div className="bg-gray-100">
      ...
      <nav className="bg-slate-700 px-4 lg:px-6 h-16 flex items-center justify-between relative shadow-lg">
        ...
        <div className="flex-1 max-w-md ml-4 mr-2 relative">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            <Search className="h-4 w-4 text-slate-400" />
          </div>
          <input
            type="text"
            className="block w-full pl-10 pr-3 py-2 border-0 rounded-lg bg-slate-600 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-slate-500 transition-all duration-200"
            placeholder="Search..."
          />
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* Notification Button */}
          <button className="relative p-2 text-slate-300 hover:text-white hover:bg-slate-600 rounded-lg transition-colors duration-200">
