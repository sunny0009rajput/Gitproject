...
// collapse work on both in mobile view and desktop 
      ...
      <div className={`bg-slate-800 text-white transition-all duration-300 ease-in-out flex flex-col shadow-xl ${
        ...
        <div className="flex items-center justify-center lg:justify-start p-4 border-b border-slate-700">
          <button 
            ...
            className="w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center flex-shrink-0 hover:from-blue-600 hover:to-purple-700 transition-all duration-200 hover:scale-105 lg:cursor-pointer cursor-default"
            title="Toggle sidebar (desktop only)"
          >
