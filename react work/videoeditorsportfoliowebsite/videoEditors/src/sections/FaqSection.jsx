      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            <HelpCircle className="w-8 h-8 sm:w-10 sm:h-10 text-green-500" />
        ...
        <div className="space-y-4">
          {faqs.map((faq) => (
            <div
              key={faq.id}
              className="bg-green-300/10 border border-gray-700 rounded-lg overflow-hidden hover:border-gray-600 transition-colors duration-200"
            >
              {/* Question Header */}
              <button
                onClick={() => toggleFAQ(faq.id)}
                className="w-full text-left p-4 sm:p-6 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-inset group"
              >
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex-shrink-0">
                    {expandedFAQ === faq.id ? (
                      <ChevronUp className="w-5 h-5 sm:w-6 sm:h-6 text-green-500 transform transition-transform duration-200" />
                    ) : (
                      <ChevronDown className="w-5 h-5 sm:w-6 sm:h-6 text-gray-400 group-hover:text-green-500 transform transition-all duration-200" />
                    )}
                  </div>
                </div>
              </button>
        ...
        <div className="mt-12 sm:mt-16 text-center">
          <div className="bg-gradient-to-r from-green-600/10 to-green-800/10 border border-green-600/20 rounded-xl p-6 sm:p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-green-600 hover:bg-green-500 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300 flex items-center justify-center gap-2">
        ...
        <div className="mt-12 sm:mt-16">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-green-500 mb-2">24/7</div>
              <div className="text-gray-400 text-sm">Support Available</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-green-500 mb-2">10K+</div>
              <div className="text-gray-400 text-sm">Students Helped</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-green-500 mb-2">&lt; 1hr</div>
