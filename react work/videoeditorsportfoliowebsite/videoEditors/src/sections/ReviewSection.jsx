...
const ReviewSection = () => {
  ...
  const reviews = [
    {
      ...
      testimonial:
        "This course completely transformed my YouTube journey. The strategies are practical and results-driven!",
    },
    {
      id: 2,
      name: "Drushti A",
      ...
      testimonial:
        "Amazing content! I went from 100 subscribers to 10K in just 6 months using these techniques.",
    },
    {
      id: 3,
      name: "Meenal G",
      ...
      testimonial:
        "The editing techniques taught here are incredible. My videos look so much more professional now!",
    },
    {
      id: 4,
      name: "Rohit K",
      ...
      testimonial:
        "Best investment I made for my content creation career. Highly recommended!",
    },
    {
      id: 5,
      name: "Priya M",
      rating: 5,
      thumbnail:
        "https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=400&h=300&fit=crop&crop=face",
      videoUrl:
        "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4", // Sample video
      testimonial:
        "The monetization strategies are gold! I started earning within the first month.",
    },
  ];
  ...
  return (
    <div className="bg-black min-h-screen py-12 px-4 sm:py-20">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <div className="flex -space-x-2">
                  ...
                  <div className="w-10 h-10 bg-green-600 rounded-full border-2 border-black flex items-center justify-center">
          ...
          <div className="lg:col-span-8 relative">
            ...
            <button
              onClick={prevSlide}
              className="absolute left-1 sm:left-2 top-1/2 -translate-y-1/2 z-20 w-8 h-8 sm:w-10 sm:h-10 bg-black/50 hover:bg-black/70 rounded-full flex items-center justify-center transition-colors duration-200 backdrop-blur-sm"
            >
            ...
            <button
              onClick={nextSlide}
              className="absolute right-1 sm:right-2 top-1/2 -translate-y-1/2 z-20 w-8 h-8 sm:w-10 sm:h-10 bg-black/50 hover:bg-black/70 rounded-full flex items-center justify-center transition-colors duration-200 backdrop-blur-sm"
            >
            ...
            <div className="overflow-hidden">
              ...
              >
                {reviews.map((review) => (
                  <div
                    key={review.id}
                    className="flex-shrink-0 px-2 w-[30%] sm:w-1/2 lg:w-1/3"
                  >
                    <div className="bg-black rounded-2xl overflow-hidden border border-gray-700 hover:border-gray-600 transition-all duration-300 group">
                      {/* Video Container */}
                      <div className="relative h-[200px] sm:h-[320px] md:h-[400px] lg:h-[450px] flex justify-center items-center bg-gradient-to-br from-pink-900/20 to-green-900/20">
                        <video
                          ref={(el) => (videoRefs.current[review.id] = el)}
                          className="w-[80%] sm:w-full h-full object-cover rounded-xl"
                        ...
                        >
                          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-white/90 hover:bg-white rounded-full flex items-center justify-center transition-all duration-200 group-hover/play:scale-110 shadow-lg">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {visibleTestimonials.map((testimonial, index) => (
              ...
              >
                {/* Quote Icon */}
                <div className="text-4xl text-green-700 font-serif leading-none mb-2">
                  "
                </div>
