          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-3">
              <div className="flex items-center space-x-1">
                <div className="w-8 h-8 bg-green-600 transform rotate-45 rounded-sm"></div>
                <div className="text-white">
                  <div className="text-lg font-bold leading-none">VIDEO EDITOR</div>
                  <div className="text-green-500 text-lg font-bold leading-none">sunny</div>
                </div>
              </div>
            </div>
