...
export default function PricingPage() {
  ...
  const plans = [
  {
    ...
    buttonStyle:
      "bg-white/10 hover:bg-white/20 border border-gray-600/50",
  },

  {
    ...
    buttonStyle:
      "bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-700 hover:to-orange-700 shadow-lg shadow-purple-500/25",
  },
      ...
      >
        ...
        {plan.popular && (
          <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 z-20">
            <div className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-3 py-1 md:px-4 md:py-2 rounded-full text-xs md:text-sm font-semibold shadow-lg">
              Popular
            </div>
          </div>
        )}
        ...
        >
          ...
          <div className="relative p-4 md:p-6 lg:p-8 flex flex-col h-full">
            ...
            <div className="flex items-center justify-center mb-4 md:mb-6">
              <div
                className={`p-2 md:p-3 rounded-lg md:rounded-xl bg-gradient-to-br ${plan.gradient} shadow-lg`}
              >
            ...
            <div className="text-center mb-4 md:mb-6">
              <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-1 md:mb-2">
                {plan.name}
              </h3>
            ...
            <div className="text-center mb-4 md:mb-6">
              <div className="flex items-baseline justify-center">
                <span className="text-[18px] sm:text-[22px] md:text-3xl font-bold text-black whitespace-nowrap">
  {plan.price}
</span>
              </div>
            </div>
            ...
            <div className="space-y-2 md:space-y-3 mb-4 md:mb-6 flex-grow">
              {plan.features.map((feature, idx) => (
                ...
                >
                  <Check className="w-3 h-3 md:w-4 md:h-4 text-green-500 mt-0.5 mr-2 md:mr-3 flex-shrink-0" />
            ...
            <div className="mt-auto">
              <a
                ...
                className={`w-full flex items-center justify-center py-2.5 md:py-3 lg:py-4 rounded-lg md:rounded-xl font-semibold text-black text-sm md:text-base transition-all duration-300 transform hover:scale-105 ${plan.buttonStyle}`}
              >
                Get Started
              </a>
            </div>
  ...
  return (
    <div
      id="Pricing_Plan"
      className="relative min-h-screen bg-gradient-to-br from-white via-white to-white overflow-hidden"
    >
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 py-8 md:py-16">
        ...
        <div className="text-center mb-8 md:mb-12 lg:mb-16">
          ...
          <p className="text-sm md:text-lg lg:text-xl text-gray-700 max-w-2xl lg:max-w-3xl mx-auto">
