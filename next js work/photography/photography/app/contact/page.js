...
export default function ContactSection() {
  ...
  return (
    <div className="bg-white text-black overflow-x-hidden">
      {/* HERO */}
      <section className="relative h-[400px] bg-gradient-to-br from-black via-black to-black text-white overflow-hidden">
      ...
      {/* CONTACT SECTION */}
      <section className="py-20 bg-gradient-to-b from-black to-gray-800">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="flex space-x-4">
                {[
                  ...
                  <a
                    ...
                    className={`w-12 h-12 bg-white backdrop-blur-sm rounded-full flex items-center justify-center text-gray-900 transition-all duration-300 ${s.color} hover:scale-110 hover:shadow-lg`}
                  >
                    {s.icon}
                  </a>
                ))}
          ...
          <form
            ...
            className="bg-black p-8 rounded-2xl border border-gray-00 shadow-sm space-y-6"
          >
            {["name", "email", "phone"].map((field) => (
              <div key={field}>
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-700 rounded-lg text-white placeholder-white focus:border-blue-500 focus:outline-none transition-colors"
                />
                {errors[field] && (
                  <p className="text-white text-sm mt-1">{errors[field]}</p>
                )}
              </div>
            ))}
            <div>
              <textarea
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 border border-gray-700 rounded-lg text-white placeholder-white focus:border-blue-500 focus:outline-none resize-none transition-colors"
              />
              {errors.message && (
