...
export async function generateMetadata() {
  ...
  const title = "Railway Group D GK Questions & Answers – CodeMonarch Academy";
  const description = `Access Railway Group D GK chapters like ${chapters
    .map((c) => c.title)
...
function SEOStaticContent() {
  ...
  return (
    <div id="seo-content" style={{ display: "none" }}>
      <h1>Railway Group D GK Questions and Answers – CodeMonarch Academy</h1>
