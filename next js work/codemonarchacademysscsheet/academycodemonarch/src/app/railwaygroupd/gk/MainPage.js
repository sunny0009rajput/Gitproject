...
import gkData from "../../data/groupdgk.json"; // local JSON
import {
  getChapterProgress,
  updateProblemStatus,
  updateFavourite,
  ...
  return (
    <div className="min-h-screen bg-black text-white pt-18 px-2 py-2 lg:px-28 lg:py-28">
      ...
      <div className="flex justify-end mb-4">
        <button
          onClick={() => router.push("/railwaygroupd/gk/revision")}
