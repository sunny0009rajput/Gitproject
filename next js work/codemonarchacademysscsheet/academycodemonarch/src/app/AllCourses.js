...
export default function AllCourses() {
  ...
  const cards = [
    ...
    {
      id: 5,
      title: "Railway Group D GK Sheet",
      description:
        "Railway Group D GK Sheet – Access all important Railway Group D General Knowledge questions, including previous years’ and high-priority topics, to boost your exam preparation efficiently.",
      image: "groupdlogo.png",
      gradient: "from-blue-500 to-cyan-500",
      bgGradient: "from-blue-50 to-cyan-50",
      url: "/railwaygroupd/gk",
    },
  ];
