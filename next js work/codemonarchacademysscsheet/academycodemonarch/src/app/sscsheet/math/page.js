  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        <h1 className="text-4xl font-bold mb-4">SSC Math Sheet</h1>
        <p className="text-xl text-white/80 mb-8">Coming Soon</p>
        <p className="text-lg text-white/60">We are preparing comprehensive math questions and solutions for you.</p>
      </div>
      <FooterSection />
    </div>
  );
