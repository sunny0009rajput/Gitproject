...
export default function PrivacyPolicyPage() {
  return (
    ...
    <div className="max-w-4xl mx-auto p-6 text-white mt-10">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-3">3. Advertising & Ad Choices</h2>
      <p className="mb-6">
        We use <strong>Google AdSense</strong> to serve ads on our Website. Google uses cookies to deliver personalized ads based on your previous visits to this and other websites. We do not use multiple ad networks on the same page to maintain user experience and comply with advertising standards.
      </p>
      <p className="mb-6">
        <strong>Your ad choices:</strong> You can opt out of personalized advertising by visiting
        <a
