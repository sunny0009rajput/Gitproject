      ...
      <div className="max-w-7xl mx-auto mt-10">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <p className="text-white/90 text-base lg:text-lg leading-relaxed">
                At CodeMonarch Academy, we are passionate about helping students excel in government exams. Our expertise lies in creating concise, easy-to-understand, and highly organized educational sheets that cover previous years&apos; questions and all important topics.
              </p>
              
              <p className="text-white/90 text-base lg:text-lg leading-relaxed">
                We strongly believe in empowering students through structured learning, efficient revision, and clarity of concepts. Our goal is to simplify government exam preparation, save your time, and help you achieve success with confidence.
              </p>

              <p className="text-white/90 text-base lg:text-lg leading-relaxed">
                Founded by <strong>Sunny Rajput</strong>, our platform combines years of experience in competitive exam coaching with modern technology to deliver quality educational content. We are committed to providing free, high&ndash;quality study materials to every student preparing for SSC and other government exams.
              </p>

              <p className="text-white/90 text-base lg:text-lg leading-relaxed">
                <strong>Our Mission:</strong> To democratize education by providing affordable, accessible, and effective exam preparation resources to students across India. We believe that quality education should not be limited by financial constraints.
              </p>

              <p className="text-white/90 text-base lg:text-lg leading-relaxed">
                <strong>What We&apos;Offer:</strong>
                <ul className="list-disc ml-6 mt-3 space-y-2">
                  <li>Comprehensive SSC exam question banks with answers</li>
                  <li>Previous years&apos; exam solutions and explanations</li>
                  <li>Organized study materials for easy revision</li>
                  <li>Regular updates with latest exam patterns</li>
                  <li>Free access to all premium content</li>
                </ul>
              </p>
            </div>
        ...
        <div className="block md:hidden space-y-8">
          ...
          <div className="text-center space-y-6">
            ...
            {/* Mobile Social Links */}
            <div className="pt-4">
              <p className="text-white/80 text-sm mb-4">Find Codemonarch on:</p>
